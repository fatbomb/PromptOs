      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {teamInfo ? (
          ...
          <div className="text-center p-12 bg-white dark:bg-[#0f172a] rounded-3xl border border-black/5 dark:border-white/5 shadow-sm max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl font-extrabold text-[var(--text-primary)] mb-3 tracking-tight">Solo Mode Active</h2>
            <p className="text-[var(--text-secondary)] font-medium mb-10 max-w-sm mx-auto leading-relaxed">You haven't joined a team yet. Create your own team or join an existing one to compete on AI dependency rankings.</p>
